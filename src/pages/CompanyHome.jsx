...
export default function CompanyHome() {
  ...
  // Handle PDF preview with blob conversion
  ...
  // Fetch company jobs and all users
  useEffect(() => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <p className="text-gray-600 mb-6">Manage your job postings and applicants</p>
        ...
        {companyJobs.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button
              ...
              className="mt-4 bg-orange-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition"
            >
              Post Your First Job
            </button>
          </div>
              ...
              return (
                <div key={job.id} className="relative">
                  ...
                  <button
                    ...
                    className="mt-2 w-full bg-orange-600 text-white py-2 rounded-lg hover:bg-orange-700 transition font-medium"
                  >
          ...
          >
            <div className="sticky top-0 bg-white border-b p-5 flex justify-between items-center">
              <div>
                ...
                <p className="text-purple-600 font-semibold">{selectedJob.title}</p>
                <p className="text-sm text-gray-500">{selectedJob.company} • {selectedJob.location}</p>
              </div>
              <button onClick={() => setShowApplicantsModal(false)} className="text-gray-500 hover:text-gray-700 text-2xl">
                ✕
              </button>
            </div>
            <div className="p-6">
              {(() => {
                ...
                if (jobApplicants.length === 0) {
                  return <div className="text-center py-10"><p className="text-gray-500">No applicants yet for this position.</p></div>;
                }
                return (
                        ...
                        <div key={idx} className="border rounded-lg p-4 hover:shadow-md transition">
                          <div className="flex items-center gap-4">
                            {applicant?.profilePic ? (
                              <img src={applicant.profilePic} alt="Profile" className="w-16 h-16 rounded-full object-cover border-2 border-purple-200" />
                            ) : (
            ...
            <div className="sticky bottom-0 bg-gray-50 border-t p-4 flex justify-end">
              <button onClick={() => setShowApplicantsModal(false)} className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 transition">
                Close
              </button>
            </div>
          </div>
        ...
        >
          ...
          >
            <div className="sticky top-0 bg-white border-b p-5 flex justify-between items-center">
              ...
              <button onClick={() => setShowApplicantDetailModal(false)} className="text-gray-500 hover:text-gray-700 text-2xl">
                ✕
              </button>
            </div>
            <div className="p-6">
              <div className="flex flex-col md:flex-row gap-6 items-start border-b pb-6 mb-6">
                <div className="flex-shrink-0">
                  {selectedApplicant.profilePic ? (
                    <img src={selectedApplicant.profilePic} alt="Profile" className="w-32 h-32 rounded-full object-cover border-4 border-purple-200" />
                  ) : (
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-1">📧 {selectedApplicant.email}</p>
                  {selectedApplicant.phone && <p className="text-gray-600 mb-1">📞 {selectedApplicant.phone}</p>}
                  {selectedApplicant.age && <p className="text-gray-600 mb-1">🎂 Age: {selectedApplicant.age}</p>}
                  {selectedApplicant.gender && <p className="text-gray-600 mb-1">⚥ Gender: {selectedApplicant.gender}</p>}
                </div>
              </div>
              <div className="mb-6">
                ...
                {selectedApplicant.cv ? (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-purple-50 border-2 border-purple-200 rounded-lg p-4 hover:bg-purple-100 transition"
                  >
            ...
            <div className="sticky bottom-0 bg-gray-50 border-t p-4 flex justify-end">
              <button onClick={() => setShowApplicantDetailModal(false)} className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400 transition">
                Close
              </button>
            </div>
          </div>
